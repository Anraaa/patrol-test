...
<body>
        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <div class="location-card">
                    ...
                    <div class="location-name"><?php echo e($location->name); ?></div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($location->radius_meters): ?>
                        <div class="location-radius">Radius yang diizinkan: <?php echo e($location->radius_meters); ?> meter</div>
                ...
                <div class="back-section">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAuthenticated): ?>
                        <a href="<?php echo e(route('filament.admin.pages.dashboard')); ?>" class="btn btn-secondary">← Kembali ke Dashboard</a>
                    <?php else: ?>
    ...
    <script>
        const VALIDATE_URL = '/scan-qr/<?php echo e($location->uuid); ?>/validate-gps';
...
<?php /**PATH /root/gawe/PatrolHR/resources/views/qr-scan-validate.blade.php ENDPATH**/ ?>