...
class ActionPolicy
{
    ...
    {
        return $user->can('view_any_action');
    }
    ...
    {
        return $user->can('delete_any_action');
    }
     ...
     */
    public function replicate(User $user, Action $action): bool
    {
