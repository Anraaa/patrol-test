...
class PatrolPolicy
{
    ...
    {
        return $user->can('view_any_patrol');
    }
    ...
    {
        return $user->can('delete_any_patrol');
    }
     ...
     */
    public function replicate(User $user, Patrol $patrol): bool
    {
